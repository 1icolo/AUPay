...
class Ui_AdminWindow(object):
    ...
    def retranslateUi(self, AdminWindow):
        ...
        item.setText(_translate("AdminWindow", "63cbf5e5947050d54c2ce880"))
        item = self.usersTable.item(0, 1)
        item.setText(_translate("AdminWindow", "2052522"))
        item = self.usersTable.item(0, 2)
        item.setText(_translate("AdminWindow", "~@FV7HMg++Aq[4&H/}."))
        item = self.usersTable.item(0, 3)
        item.setText(_translate("AdminWindow", "sJuoYtp%|-+YgQcjdyb"))
        item = self.usersTable.item(0, 4)
        item.setText(_translate("AdminWindow", "student"))
        item = self.usersTable.item(0, 5)
        item.setText(_translate("AdminWindow", "12403.00"))
        ...
        item.setText(_translate("AdminWindow", "1651363200"))
        item = self.transactionsTable.item(0, 2)
        item.setText(_translate("AdminWindow", "2052522"))
        item = self.transactionsTable.item(0, 3)
        item.setText(_translate("AdminWindow", "CAFETERIA"))
        item = self.transactionsTable.item(0, 4)
        item.setText(_translate("AdminWindow", "65"))
        item = self.transactionsTable.item(0, 5)
        item.setText(_translate("AdminWindow", "burger"))
