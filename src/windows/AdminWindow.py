...
def AdminWindow(self, user):
    ...
    self.adminWindow_transaction_search.textChanged.connect(lambda text: search_transactions(text, self.adminWindow_transactions_table,  self.graphicsView_3))
    load_bar_chart(self.adminWindow_transactions_table, self.graphicsView_3)
    self.dateFrom_administrator.dateChanged.connect(lambda: search_transactions_by_date(self.adminWindow_transactions_table, self.dateFrom_administrator, self.dateTo_administrator, self.graphicsView_3))
    self.dateTo_administrator.dateChanged.connect(lambda: search_transactions_by_date(self.adminWindow_transactions_table, self.dateFrom_administrator, self.dateTo_administrator, self.graphicsView_3))
