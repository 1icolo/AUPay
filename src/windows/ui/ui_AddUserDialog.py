...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.cardID_addUser = QtWidgets.QSpinBox(self.formLayoutWidget)
        self.cardID_addUser.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.cardID_addUser.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.cardID_addUser.setMaximum(10000000)
        ...
        self.schoolID_addUser = QtWidgets.QSpinBox(self.formLayoutWidget)
        self.schoolID_addUser.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.schoolID_addUser.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.schoolID_addUser.setMaximum(10000000)
        self.schoolID_addUser.setStepType(QtWidgets.QAbstractSpinBox.DefaultStepType)
        ...
        self.balance_addUser = QtWidgets.QDoubleSpinBox(self.formLayoutWidget)
        self.balance_addUser.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.balance_addUser.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.balance_addUser.setMaximum(10000000.99)
