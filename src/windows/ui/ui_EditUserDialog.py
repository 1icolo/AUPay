...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self._id_editUser = QtWidgets.QLineEdit(Dialog)
        self._id_editUser.setGeometry(QtCore.QRect(120, 20, 210, 20))
        self._id_editUser.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self._id_editUser.setFocusPolicy(QtCore.Qt.WheelFocus)
        self._id_editUser.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self._id_editUser.setFrame(True)
        self._id_editUser.setEchoMode(QtWidgets.QLineEdit.Normal)
        self._id_editUser.setClearButtonEnabled(False)
        self._id_editUser.setObjectName("_id_editUser")
