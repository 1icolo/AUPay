...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.businessIDLabel = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(16)
        self.businessIDLabel.setFont(font)
        self.businessIDLabel.setObjectName("businessIDLabel")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.businessIDLabel)
        self.businessIDLineEdit = QtWidgets.QLineEdit(Dialog)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(16)
        self.businessIDLineEdit.setFont(font)
        self.businessIDLineEdit.setReadOnly(True)
        self.businessIDLineEdit.setObjectName("businessIDLineEdit")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.businessIDLineEdit)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.userIDLabel)
        self.userIDLineEdit = QtWidgets.QLineEdit(Dialog)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(16)
        self.userIDLineEdit.setFont(font)
        self.userIDLineEdit.setReadOnly(True)
        self.userIDLineEdit.setObjectName("userIDLineEdit")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.userIDLineEdit)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.buttonScanUser)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.buttonScanBusiness)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.businessIDLabel.setText(_translate("Dialog", "Business ID:"))
